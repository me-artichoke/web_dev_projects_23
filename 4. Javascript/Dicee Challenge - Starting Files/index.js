...
document.querySelector(".img2").setAttribute("src", images2[randomNumber1]);

if(images[randomNumber1] > images2[randomNumber1]){
    document.querySelector("h1").innerHTML = "Player 1 Wins!";
} else if (images2[randomNumber1] > images[randomNumber1]){
